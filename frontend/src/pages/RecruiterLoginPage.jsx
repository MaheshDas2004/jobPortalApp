      ...
      <div className="w-1/2 bg-white flex flex-col items-center justify-center p-12 relative">
        ...
        <div className="w-full max-w-xl">
         ...
         <div className="absolute top-8 right-8 text-right">
          ...
          <p className="text-sm font-semibold text-gray-600 mt-1">For Recruiters</p>
        </div>

          {/* Welcome Section */}
          <div className=" text-center">
            <h1 className="text-4xl font-extrabold text-gray-900 mb-2">Log in</h1>
            <p className="text-base text-gray-700">Access your recruiter dashboard</p>
          </div>
          ...
          <div className="bg-white p-10 mb-8">
            <div className="space-y-6">
              ...
              <div className="mt-6 flex justify-between items-center">
                ...
                <a href="#" className="text-sm font-bold text-gray-900 hover:underline uppercase">Are you a job seeker?</a>
              </div>
            </div>
          </div>
