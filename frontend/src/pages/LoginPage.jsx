...
export default function LoginPage() {
  ...
  <div className="w-1/2 relative h-full shrink-0">
        ...
        <div className="absolute left-12 bottom-20 z-30 text-left flex items-center gap-4">
          {/* <img src={hmxLogo} alt="Hire Matrix" className="h-15 w-27 object-contain" /> */}
      ...
      <div className="w-1/2 bg-white flex flex-col items-center justify-center p-8 h-full overflow-y-auto">
        ...
        <div className="w-full max-w-lg flex flex-col justify-center">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-700">Access your job dashboard</p>
          </div>
          ...
          <div className="bg-white p-4 mb-4">
            <div className="space-y-4">
              ...
              <div className="mt-4 flex justify-between items-center">
                ...
                <span className="text-xs font-bold text-gray-900 hover:underline uppercase cursor-pointer">Are you a recruiter?</span>
              </div>
            </div>
          </div>
